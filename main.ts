...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    Clicker.changeScale(2, ScaleAnchor.Middle)
    pause(100)
    Clicker.changeScale(-2, ScaleAnchor.Middle)
})
...
game.splash("Press start", "COIN CLICKER")
...
scene.setBackgroundImage(img`
    ...
    `)
Clicker.setScale(5, ScaleAnchor.Middle)
let statusbar = statusbars.create(100, 6, StatusBarKind.Time)
statusbar.setColor(7, 2, 5)
statusbar.setOffsetPadding(-15, 2)
statusbar.positionDirection(CollisionDirection.Bottom)
statusbar.setBarBorder(1, 15)
statusbar.setLabel("TIME")
